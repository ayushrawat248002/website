...
const { scrollYProgress: scrollZProgress } = useScroll({
  ...
  const scaleFg = useTransform(scrollYProgress, [0.43, 0.48], [0.5, 1]); // settle in
    ...
    const yBg2 = useTransform(scrollZProgress, [0, 0.3], [100, 0]);
  const yFg2= useTransform(scrollZProgress, [0.2, 0.4], [100, 50]);

  // Crossfade
  const opacityBg2 = useTransform(scrollZProgress, [0.4, 0.5], [1, 0]);
  const opacityFg2 = useTransform(scrollZProgress, [0.1, 0.3], [0, 1]);

  // 🔥 Scale effect
  const scaleBg2 = useTransform(scrollZProgress, [0.3, 0.5], [1, 0.3]); // shrink
  const scaleFg2 = useTransform(scrollZProgress, [0.43, 0.45 ], [0.5, 1]); // settle in

return(
    <>
          <section ref={ref} className="h-auto bg-gray-50  backdrop-blur-md">
      ...
      <div  className="relative flex flex-col items-start">
        ...
        <motion.div
          ...
          className="h-[450px] w-full sticky top-20 bg-cover scale-100 bg-center rounded-none shadow-xl z-[10]"
        />
  ...
  <div className="grid overflow-x-scroll snap-mandatory snap-x grid-cols-[repeat(3,300px)] gap-6 mt-10">
    ...
    <div className="bg-white rounded-2xl snap-start p-4 shadow-sm hover:shadow-md transition">
      ...
      <p className="text-gray-500 text-sm">₹4,999</p>
          ...
          {/* CTA */}
  <div className="mt-12">
    <button className="px-8 py-3 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 transition">
            Explore Collection
          </button>
  </div>
        </motion.div>
      ...
      <section ref={secondRef} className="h-auto  bg-gray-50 backdrop-blur-md">
                <div  className="relative flex flex-col items-start">
  ...
  className="min-h-[820px] w-full  sticky  rounded-3xl shadow-xl z-[40] 
...
>
  ...
  <div className="max-w-2xl">
    ...
    <h2 className="text-5xl font-semibold text-neutral-900 leading-tight">
  ...
  <div className="mt-12 overflow-x-auto snap-x snap-mandatory flex gap-8 pb-8">
    ...
    <div className="min-w-[270px] snap-start bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
      ...
      <p className="text-neutral-900 font-medium text-lg">Linen Shirt</p>
    ...
    <div className="min-w-[270px] snap-center bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
      <div className="h-64 bg-neutral-200 rounded-xl mb-5" />
      <p className="text-neutral-900 font-medium text-lg">Tailored Trousers</p>
    ...
    <div className="min-w-[270px] snap-start bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
      <div className="h-64 bg-neutral-200 rounded-xl mb-5" />
      <p className="text-neutral-900 font-medium text-lg">Leather Sneakers</p>
    ...
    <div className="min-w-[280px] snap-start bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
      <div className="h-64 bg-neutral-200 rounded-xl mb-5" />
      <p className="text-neutral-900 font-medium text-lg">Overshirt Jacket</p>
  ...
  <div className="mt-7 flex items-center justify-between">
    ...
    <button className="px-8 py-3 rounded-xl bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-all duration-300">
